...
EXPECTED_RGSS2_STRUCTURES = {
  ...
  "RPG::System" => Set.new(["@game_title", "@version_id", "@party_members", "@elements", "@switches", "@variables", "@passages", "@boat", "@ship", "@airship", "@title_bgm", "@battle_bgm", "@battle_end_me", "@gameover_me", "@sounds", "@test_battlers", "@test_troop_id", "@start_map_id", "@start_x", "@start_y", "@terms", "@battler_name", "@battler_hue", "@edit_map_id"]),
