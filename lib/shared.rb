...
module RPG
  ...
  class System
    ...
    attr_accessor :passages # RGSS2 (可能存在)
    attr_accessor :game_title, :version_id, :party_members, :elements, :switches, :variables # 共用
    attr_accessor :boat, :ship, :airship, :title_bgm, :battle_bgm, :battle_end_me, :gameover_me # 共用
    attr_accessor :sounds, :test_battlers, :test_troop_id, :start_map_id, :start_x, :start_y # 共用
    attr_accessor :terms, :battler_name, :battler_hue, :edit_map_id, :magic_number # 共用
    ...
    def initialize(rgss_version = "RGSS3")
      ...
      if rgss_version == "RGSS3"
        ...
        @terms = RPG::System::Terms.new(rgss_version)
    ...
    class TestBattler
      ...
      attr_accessor :equips # RGSS3: 装备ID列表
